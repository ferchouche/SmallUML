 ...
 * </p>
 * <ul>
 *   <li>{@link smalluml.impl.EnumerationImpl#getVariable <em>Variable</em>}</li>
...
public class EnumerationImpl extends TypeImpl implements Enumeration {
	...
	public EList<String> getVariable() {
		if (variable == null) {
			variable = new EDataTypeUniqueEList<String>(String.class, this, SmallumlPackage.ENUMERATION__VARIABLE);
		}
		return variable;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmallumlPackage.ENUMERATION__VARIABLE:
				return getVariable();
