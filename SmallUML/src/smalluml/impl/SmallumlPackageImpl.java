...
public class SmallumlPackageImpl extends EPackageImpl implements SmallumlPackage {
	 ...
	 * @generated
	 */
	private EClass cardinalitiesEClass = null;
	 ...
	 * @generated
	 */
	public EReference getClassDiagram_Entities() {
	 ...
	 * @generated
	 */
	public EReference getOperation_TypeReturn() {
	 ...
	 * @generated
	 */
	public EClass getCardinalities() {
		return cardinalitiesEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getCardinalities_Lowerbound() {
		return (EAttribute)cardinalitiesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCardinalities_Upperbound() {
		return (EAttribute)cardinalitiesEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getAssociation_Cardinalities() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_Targetclass() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_Sourceclass() {
	 ...
	 * @generated
	 */
	public EAttribute getEnumeration_Variable() {
	...
	public void createPackageContents() {
		...
		createEReference(classDiagramEClass, CLASS_DIAGRAM__ENTITIES);

		operationEClass = createEClass(OPERATION);
		createEAttribute(operationEClass, OPERATION__NAME);
		createEReference(operationEClass, OPERATION__TYPE_RETURN);
		...
		cardinalitiesEClass = createEClass(CARDINALITIES);
		createEAttribute(cardinalitiesEClass, CARDINALITIES__LOWERBOUND);
		createEAttribute(cardinalitiesEClass, CARDINALITIES__UPPERBOUND);

		associationEClass = createEClass(ASSOCIATION);
		createEReference(associationEClass, ASSOCIATION__CARDINALITIES);
		createEReference(associationEClass, ASSOCIATION__TARGETCLASS);
		createEReference(associationEClass, ASSOCIATION__SOURCECLASS);
		...
		createEAttribute(enumerationEClass, ENUMERATION__VARIABLE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getClass_Abstract(), ecorePackage.getEBoolean(), "abstract", null, 0, 1, smalluml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClassDiagram_Entities(), this.getEntity(), null, "entities", null, 0, -1, ClassDiagram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(operationEClass, Operation.class, "Operation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOperation_Name(), ecorePackage.getEString(), "name", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperation_TypeReturn(), this.getType(), null, "typeReturn", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(cardinalitiesEClass, Cardinalities.class, "Cardinalities", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCardinalities_Lowerbound(), ecorePackage.getEInt(), "lowerbound", null, 1, 1, Cardinalities.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCardinalities_Upperbound(), ecorePackage.getEInt(), "upperbound", null, 1, 1, Cardinalities.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(associationEClass, Association.class, "Association", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAssociation_Cardinalities(), this.getCardinalities(), null, "cardinalities", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssociation_Targetclass(), this.getClass_(), null, "targetclass", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssociation_Sourceclass(), this.getClass_(), null, "sourceclass", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEnumeration_Variable(), ecorePackage.getEString(), "variable", null, 0, -1, Enumeration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
